...
private:
  ...
  rclcpp::Subscription<autoware_planning_msgs::msg::VelocityLimit>::SharedPtr speed_limit_sub_;
  ...
  void updateSpeedLimitData(const autoware_planning_msgs::msg::VelocityLimit::ConstSharedPtr msg);
