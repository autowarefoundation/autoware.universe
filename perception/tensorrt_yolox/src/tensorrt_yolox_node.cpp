...
: Node("tensorrt_yolox", node_options)
{
  ...
  std::string model_path = declare_parameter_with_description("model_path", "");
  std::string label_path = declare_parameter_with_description("label_path", "");
  ...
  bool preprocess_on_gpu = declare_parameter_with_description(
      ...
      "If true, pre-processing is performed on GPU");
  ...
  tensorrt_common::BuildConfig build_config(calibration_algorithm, dla_core_id,
