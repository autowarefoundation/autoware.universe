...
| `use_intensity_feature` | _bool_  | Enable input channel internsity feature.                                                                                                                      | `true`  |
...
It could be converted to a `DetectedObstacle` the same way the euclidean_cluster_nodes package
