...
class TRTPluginBase : public nvinfer1::IPluginV2DynamicExt {
 public:
  ...
  virtual void configurePlugin([[maybe_unused]] const nvinfer1::DynamicPluginTensorDesc *in, [[maybe_unused]] int nbInputs,
                               [[maybe_unused]] const nvinfer1::DynamicPluginTensorDesc *out,
                               [[maybe_unused]] int nbOutputs) TRT_NOEXCEPT override {}

  virtual size_t getWorkspaceSize([[maybe_unused]] const nvinfer1::PluginTensorDesc *inputs, [[maybe_unused]] int nbInputs,
                                  [[maybe_unused]] const nvinfer1::PluginTensorDesc *outputs,
                                  [[maybe_unused]] int nbOutputs) const TRT_NOEXCEPT override {
    return 0;
  }

  virtual void attachToContext([[maybe_unused]] cudnnContext *cudnnContext, [[maybe_unused]] cublasContext *cublasContext,
