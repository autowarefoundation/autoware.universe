...
size_t TRTBatchedNMS::getWorkspaceSize(const nvinfer1::PluginTensorDesc* inputs, [[maybe_unused]] int nbInputs,
...
void TRTBatchedNMS::configurePlugin([[maybe_unused]] const nvinfer1::DynamicPluginTensorDesc* inputs, [[maybe_unused]] int nbInputs,
...
bool TRTBatchedNMS::supportsFormatCombination(int pos, const nvinfer1::PluginTensorDesc* ioDesc,
                                              [[maybe_unused]] int nbInputs, [[maybe_unused]] int nbOutputs) TRT_NOEXCEPT {
  if (pos == 3 || pos == 4) {
...
const char* TRTBatchedNMSCreator::getPluginVersion() const TRT_NOEXCEPT {
  return NMS_PLUGIN_VERSION;
    ...
    IPluginV2DynamicExt* TRTBatchedNMSCreator::createPlugin(const char* name,
  ...
  return plugin;
    ...
    IPluginV2DynamicExt* TRTBatchedNMSCreator::deserializePlugin(const char* name, const void* serialData,
