...
private:
  ...
  using TrafficLightArray = autoware_auto_perception_msgs::msg::TrafficSignalArray;
  using TrafficSignalArray = autoware_perception_msgs::msg::TrafficSignalArray;
  rclcpp::Subscription<LaneletMapBin>::SharedPtr sub_map_;
  rclcpp::Subscription<TrafficLightArray>::SharedPtr sub_lights_;
  rclcpp::Publisher<TrafficSignalArray>::SharedPtr pub_signals_;
  void on_map(const LaneletMapBin::ConstSharedPtr msg);
  void on_lights(const TrafficLightArray::ConstSharedPtr msg);
