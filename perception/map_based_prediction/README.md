...
| `min_crosswalk_user_velocity`               | [m/s] | double | minimum velocity use in path prediction for crosswalk users                                                  |
...
| `dist_threshold_for_searching_lanelet`      | [m]   | double | The threshold of the distance used when searching for the lane to which the object belongs                   |
...
| `sigma_yaw_angle`                           | [rad] | double | Standard deviation yaw angle of objects                                                                      |
...
| `dist_ratio_threshold_to_left_bound`        | [m]   | double | Conditions for using lane change detection of objects. Distance to the left bound of lanelet.                |
| `dist_ratio_threshold_to_right_bound`       | [m]   | double | Conditions for using lane change detection of objects. Distance to the right bound of lanelet.               |
| `diff_dist_threshold_to_left_bound`         | [m]   | double | Conditions for using lane change detection of objects. Differential value of horizontal position of objects. |
| `diff_dist_threshold_to_right_bound`        | [m]   | double | Conditions for using lane change detection of objects. Differential value of horizontal position of objects. |
