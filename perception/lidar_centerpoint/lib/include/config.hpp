...
public:
  ...
  constexpr static int grid_size_x = static_cast<int>((range_max_x - range_min_x) / voxel_size_x);
  constexpr static int grid_size_y = static_cast<int>((range_max_y - range_min_y) / voxel_size_y);
  constexpr static int grid_size_z = static_cast<int>((range_max_z - range_min_z) / voxel_size_z);
