...
bool isTrafficLightElementEqual(
  const TrafficElement & input_traffic_light_element,
  const TrafficElement & output_traffic_light_element)
{
...
bool isTrafficLightGroupEqual(
  const TrafficSignal & input_traffic_light_group, const TrafficSignal & output_traffic_light_group)
{
  if (
    input_traffic_light_group.traffic_light_group_id !=
    output_traffic_light_group.traffic_light_group_id) {
    return false;
  }
