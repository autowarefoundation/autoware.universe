...
#ifndef MULTI_OBJECT_TRACKER__TRACKER__OBJECT_MODEL__OBJECT_MODEL_BASE_HPP_
#define MULTI_OBJECT_TRACKER__TRACKER__OBJECT_MODEL__OBJECT_MODEL_BASE_HPP_
...
enum class ObjectModelType { NORMAL_VEHICLE, BIG_VEHICLE, BICYCLE, PEDESTRIAN, STATIC, UNKNOWN };
struct ObjectSize
{
  double length;  // [m]
  double width;   // [m]
...
#endif  // MULTI_OBJECT_TRACKER__TRACKER__OBJECT_MODEL__OBJECT_MODEL_BASE_HPP_
