...
template <>
void TrtYoloX::preprocessGpu<cv::Mat>(const std::vector<cv::Mat> & images)
{
...
template <>
void TrtYoloX::preprocessGpu<std::shared_ptr<ImageContainer>>(
...
template <>
bool TrtYoloX::feedforward<cv::Mat>(const std::vector<cv::Mat> & images, ObjectArrays & objects)
{
...
template <>
bool TrtYoloX::feedforward<std::shared_ptr<ImageContainer>>(
...
template <>
bool TrtYoloX::feedforwardAndDecode<cv::Mat>(
...
template <>
bool TrtYoloX::feedforwardAndDecode<std::shared_ptr<ImageContainer>>(
  const std::vector<std::shared_ptr<ImageContainer>> & images, ObjectArrays & objects,
...
template <>
bool TrtYoloX::doInference<cv::Mat>(
...
template <>
bool TrtYoloX::doInference<std::shared_ptr<ImageContainer>>(
  const std::vector<std::shared_ptr<ImageContainer>> & images, ObjectArrays & objects,
