...
* chore: refine maintainer list (`#10110 <https://github.com/autowarefoundation/autoware.universe/issues/10110>`_)
  ...
  * chore: add Taekjin-san to perception_utils package maintainer
  ---------
* feat(autoware_radar_crossing_objects_noise_filter): created schema file and updated readme file for parameters setting (`#10001 <https://github.com/autowarefoundation/autoware.universe/issues/10001>`_)
