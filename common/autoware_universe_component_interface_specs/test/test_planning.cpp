...
{
  {
    using autoware::universe_component_interface_specs::planning::RouteState;
    RouteState state;
    size_t depth = 1;
  ...
  {
    using autoware::universe_component_interface_specs::planning::LaneletRoute;
    LaneletRoute route;
    size_t depth = 1;
  ...
  {
    using autoware::universe_component_interface_specs::planning::Trajectory;
