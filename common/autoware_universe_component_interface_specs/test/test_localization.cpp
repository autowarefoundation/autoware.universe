...
{
  {
    using autoware::universe_component_interface_specs::localization::InitializationState;
  ...
  {
    using autoware::universe_component_interface_specs::localization::KinematicState;
  ...
  {
    using autoware::universe_component_interface_specs::localization::Acceleration;
