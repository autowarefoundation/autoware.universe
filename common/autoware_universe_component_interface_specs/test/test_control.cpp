...
{
  {
    using autoware::universe_component_interface_specs::control::IsPaused;
    IsPaused is_paused;
    size_t depth = 1;
  ...
  {
    using autoware::universe_component_interface_specs::control::IsStartRequested;
  ...
  {
    using autoware::universe_component_interface_specs::control::IsStopped;
