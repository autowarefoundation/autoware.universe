...
// clang-format off
#ifndef AUTOWARE__TRAJECTORY_CONTAINER__INTERPOLATOR__DETAIL__NEAREST_NEIGHBOR_COMMON_IMPL_HPP_  // NOLINT
#define AUTOWARE__TRAJECTORY_CONTAINER__INTERPOLATOR__DETAIL__NEAREST_NEIGHBOR_COMMON_IMPL_HPP_  // NOLINT
// clang-format on

#include "autoware/trajectory_container/interpolator/detail/interpolator_mixin.hpp"

#include <vector>

namespace autoware::trajectory_container::interpolator
{
...
// clang-format off
#endif  // AUTOWARE__TRAJECTORY_CONTAINER__INTERPOLATOR__DETAIL__NEAREST_NEIGHBOR_COMMON_IMPL_HPP_  // NOLINT
// clang-format on
