...
int main()
{
  ...
  using autoware::trajectory_container::interpolator::InterpolatorInterface;
  // Linear Interpolator
  {
    using autoware::trajectory_container::interpolator::Linear;
  ...
  {
    using autoware::trajectory_container::interpolator::AkimaSpline;
  ...
  {
    using autoware::trajectory_container::interpolator::NearestNeighbor;
    auto interpolator =
  ...
  {
    using autoware::trajectory_container::interpolator::Stairstep;
