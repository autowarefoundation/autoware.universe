...
#include "autoware/trajectory_container/trajectory/path_point_with_lane_id.hpp"

#include <gtest/gtest.h>

#include <vector>

using Trajectory = autoware::trajectory_container::trajectory::TrajectoryContainer<
...
{
  using namespace autoware::trajectory_container::trajectory;  // NOLINT
