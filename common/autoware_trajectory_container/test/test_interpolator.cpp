...
#include "autoware/trajectory_container/interpolator/akima_spline.hpp"
#include "autoware/trajectory_container/interpolator/cubic_spline.hpp"
#include "autoware/trajectory_container/interpolator/linear.hpp"
#include "autoware/trajectory_container/interpolator/nearest_neighbor.hpp"
#include "autoware/trajectory_container/interpolator/spherical_linear.hpp"
#include "autoware/trajectory_container/interpolator/stairstep.hpp"
...
using Interpolators = testing::Types<
  autoware::trajectory_container::interpolator::CubicSpline,
  autoware::trajectory_container::interpolator::AkimaSpline,
  autoware::trajectory_container::interpolator::Linear,
  autoware::trajectory_container::interpolator::NearestNeighbor<double>,
  autoware::trajectory_container::interpolator::Stairstep<double>>;
...
template class TestInterpolator<autoware::trajectory_container::interpolator::CubicSpline>;
template class TestInterpolator<autoware::trajectory_container::interpolator::AkimaSpline>;
template class TestInterpolator<autoware::trajectory_container::interpolator::Linear>;
template class TestInterpolator<
  autoware::trajectory_container::interpolator::NearestNeighbor<double>>;
template class TestInterpolator<autoware::trajectory_container::interpolator::Stairstep<double>>;
...
{
  using autoware::trajectory_container::interpolator::SphericalLinear;
  ...
  auto interpolator = autoware::trajectory_container::interpolator::SphericalLinear::Builder()
                        .set_bases(bases)
