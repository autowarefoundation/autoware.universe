...
// // clang-format off
// #ifndef
// AUTOWARE__MOTION_UTILS__TRAJECTORY_CONTAINER__TRAJECTORY__TRAJECTORY_PATH_POINT_WITH_LANE_ID_HPP_
// // NOLINT #define
// AUTOWARE__MOTION_UTILS__TRAJECTORY_CONTAINER__TRAJECTORY__TRAJECTORY_PATH_POINT_WITH_LANE_ID_HPP_
// // NOLINT
// // clang-format on
...
//     const std::shared_ptr<interpolator::Interpolator<double>> &
//     longitudinal_velocity_interpolator, const std::shared_ptr<interpolator::Interpolator<double>>
//     & lateral_velocity_interpolator, const std::shared_ptr<interpolator::Interpolator<double>> &
//     heading_rate_interpolator, const std::shared_ptr<interpolator::Interpolator<LaneIdType>> &
//     lane_id_interpolator);
