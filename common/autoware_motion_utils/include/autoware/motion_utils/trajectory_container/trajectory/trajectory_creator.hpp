...
// #include
// "autoware/motion_utils/trajectory_container/trajectory/trajectory_path_point_with_lane_id.hpp"
...
//     std::make_shared<InterpolatorType>(std::forward<Args>(args)...); orientation_y_interpolator_
//     = std::make_shared<InterpolatorType>(std::forward<Args>(args)...);
//     orientation_z_interpolator_ =
//     std::make_shared<InterpolatorType>(std::forward<Args>(args)...); orientation_w_interpolator_
//     = std::make_shared<InterpolatorType>(std::forward<Args>(args)...); return *this;
//   }
...
//   /**
//    * @brief Creates a TrajectoryContainer from a vector of points.
//    * @param points Vector of autoware_planning_msgs::msg::PathPoint to create the trajectory
//    from.
//    * @return Optional TrajectoryContainer, or nullopt if creation failed.
//    */
...
//   /**
//    * @brief Creates a TrajectoryContainer from a vector of points.
//    * @param points Vector of tier4_planning_msgs::msg::PathPointWithLaneId to create the
//    trajectory
//    * from.
//    * @return Optional TrajectoryContainer, or nullopt if creation failed.
//    */
