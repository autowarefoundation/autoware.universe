...
int main()
{
  ...
  //     path_point(0.49, 0.59), path_point(0.61, 1.22), path_point(0.86, 1.93),
  //     path_point(1.20, 2.56), path_point(1.51, 3.17), path_point(1.85, 3.76),
  //     path_point(2.14, 4.26), path_point(2.60, 4.56), path_point(3.07, 4.55),
  //     path_point(3.61, 4.30), path_point(3.95, 4.01), path_point(4.29, 3.68),
  //     path_point(4.90, 3.25), path_point(5.54, 3.10), path_point(6.24, 3.18),
  //     path_point(6.88, 3.54), path_point(7.51, 4.25), path_point(7.85, 4.93),
  //     path_point(8.03, 5.73), path_point(8.16, 6.52), path_point(8.31, 7.28),
  //     path_point(8.45, 7.93), path_point(8.68, 8.45), path_point(8.96, 8.96),
  ...
  //   auto trajectory = TrajectoryCreator<autoware_planning_msgs::msg::PathPoint>()
