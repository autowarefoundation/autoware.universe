...
//   static_cast<float>(this->longitudinal_velocity_mps.compute(s)); result.lateral_velocity_mps =
//   static_cast<float>(this->lateral_velocity_mps.compute(s)); result.heading_rate_rps =
//   static_cast<float>(this->heading_rate_rps.compute(s)); return result;
// }
