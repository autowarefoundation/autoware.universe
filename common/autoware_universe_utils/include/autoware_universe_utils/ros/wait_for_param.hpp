...
#ifndef AUTOWARE_UNIVERSE_UTILS__ROS__WAIT_FOR_PARAM_HPP_
#define AUTOWARE_UNIVERSE_UTILS__ROS__WAIT_FOR_PARAM_HPP_
...
#endif  // AUTOWARE_UNIVERSE_UTILS__ROS__WAIT_FOR_PARAM_HPP_
