...
#ifndef AUTOWARE_UNIVERSE_UTILS__ROS__UUID_HELPER_HPP_
#define AUTOWARE_UNIVERSE_UTILS__ROS__UUID_HELPER_HPP_
...
#endif  // AUTOWARE_UNIVERSE_UTILS__ROS__UUID_HELPER_HPP_
