...
#include "motion_utils/trajectory_v2/detail/merge_vector.hpp"
...
{
  longitudinal_velocity_mps.setInterpolator(interpolator);
  return *this;
}
...
TrajectoryV2<PathPoint> & TrajectoryV2<PathPoint>::set_lateral_velocity_mps_interpolator(
  const interpolator::Interpolator<double> & interpolator)
{
  lateral_velocity_mps.setInterpolator(interpolator);
  return *this;
}
...
TrajectoryV2<PathPoint> & TrajectoryV2<PathPoint>::set_heading_rate_rps_interpolator(
  const interpolator::Interpolator<double> & interpolator)
{
  heading_rate_rps.setInterpolator(interpolator);
  return *this;
}
