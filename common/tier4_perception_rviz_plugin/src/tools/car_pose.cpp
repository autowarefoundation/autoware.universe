...
TruckInitialPoseTool::TruckInitialPoseTool()
{
  // short cut below k
  shortcut_key_ = 't';
...
void TruckInitialPoseTool::onInitialize()
{
  rviz_plugins::InteractiveObjectTool::onInitialize();
  setName("2D Dummy Truck");
  updateTopic();
}

Object TruckInitialPoseTool::createObjectMsg() const
{
  Object object{};
  std::string fixed_frame = context_->getFixedFrame().toStdString();
...
PLUGINLIB_EXPORT_CLASS(rviz_plugins::TruckInitialPoseTool, rviz_common::Tool)
