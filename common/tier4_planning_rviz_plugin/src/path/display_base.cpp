...
{
template <typename T>
AutowarePathBaseDisplay<T>::AutowarePathBaseDisplay()
:  // path
...
template <typename T>
void AutowarePathBaseDisplay<T>::onInitialize()
{
...
template <typename T>
void AutowarePathBaseDisplay<T>::reset()
{
...
template <typename T>
void AutowarePathBaseDisplay<T>::processMessage(const typename T::ConstSharedPtr msg_ptr)
{
