...
{
  (void)msg;
  throw std::runtime_error("GearCommand not supported by this base Interface");
}
...
{
  (void)msg;
  throw std::runtime_error("HandBrakeCommand not supported by this base Interface");
}
...
{
  (void)msg;
  throw std::runtime_error("HazardLightsCommand not supported by this base Interface");
}
...
{
  (void)msg;
  throw std::runtime_error("HeadlightsCommand not supported by this base Interface");
}

void BaseInterface::send_horn_command(const autoware_auto_vehicle_msgs::msg::HornCommand & msg)
{
  (void)msg;
  throw std::runtime_error("HornCommand not supported by this base Interface");
}

void BaseInterface::send_wipers_command(const autoware_auto_vehicle_msgs::msg::WipersCommand & msg)
{
  (void)msg;
  throw std::runtime_error("WipersCommand not supported by this base Interface");
}
...
{
  (void)msg;
  throw std::runtime_error("TurnIndicatorsCommand not supported by this base Interface");
}
