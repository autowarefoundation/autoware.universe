...
class NeuralNetworkSteering4(Node):
    ...
    def __init__(self):
        ...
        ush = pd.read_csv("steering_04.csv")
        ...
        plt.title("Distribution of Velocity - Table 4")
        plt.xlabel("Velocity")
        ...
        plt.title("Distribution of Throttling - Table 4")
        ...
        plt.title("Distribution of Acceleration - Table 4")
