...
class NeuralNetworkSteering2(Node):
    ...
    def __init__(self):
        ...
        ush = pd.read_csv("steering_02.csv")
        ...
        plt.title("Distribution of Velocity - Table 2")
        plt.xlabel("Velocity")
        ...
        plt.title("Distribution of Throttling - Table 2")
        ...
        plt.title("Distribution of Acceleration - Table 2")
