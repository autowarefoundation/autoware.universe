...
class primotest(rclpy.node.Node):
    ...
    def __init__(self):
        ...
        self.THROTTLE_THRESHOLD = self.get_parameter(
            'throttle_threshold').get_parameter_value().integer_value
        self.STEERING_THR1 = self.get_parameter(
            'steering_threshold_1').get_parameter_value().double_value
        self.STEERING_THR2 = self.get_parameter(
            'steering_threshold_2').get_parameter_value().double_value
        self.STEERING_THR3 = self.get_parameter(
            'steering_threshold_3').get_parameter_value().double_value
        self.STEERING_THR4 = self.get_parameter(
            'steering_threshold_4').get_parameter_value().double_value
        self.STEERING_THR5 = self.get_parameter(
            'steering_threshold_5').get_parameter_value().double_value
        ...
        self.progress_bar0 = tqdm(initial=self.k, total=self.MAX_DATA, desc="                                         Low throttle | Steering: " +
                                  str(self.STEERING_THR1) + " - " + str(self.STEERING_THR2), dynamic_ncols=True)
        self.progress_bar1 = tqdm(initial=self.i, total=self.MAX_DATA, desc="                                         Low throttle | Steering:  " +
                                  str(self.STEERING_THR2) + " - " + str(self.STEERING_THR3), dynamic_ncols=True)
        self.progress_bar2 = tqdm(initial=self.j, total=self.MAX_DATA, desc="                                         Low throttle | Steering:  " +
                                  str(self.STEERING_THR3) + " - " + str(self.STEERING_THR4), dynamic_ncols=True)
        self.progress_bar3 = tqdm(initial=self.h, total=self.MAX_DATA, desc="                                         Low throttle | Steering:  " +
                                  str(self.STEERING_THR4) + " - " + str(self.STEERING_THR5), dynamic_ncols=True)
        self.progress_bar4 = tqdm(initial=self.a, total=self.MAX_DATA,
                                  desc="                                         Low throttle | Steering:  " + str(self.STEERING_THR5) + " - max", dynamic_ncols=True)
        self.progress_bar10 = tqdm(initial=self.kk, total=self.MAX_DATA, desc="                                        High throttle | Steering: " +
                                   str(self.STEERING_THR1) + " - " + str(self.STEERING_THR2), dynamic_ncols=True)
        self.progress_bar11 = tqdm(initial=self.ii, total=self.MAX_DATA, desc="                                        High throttle | Steering:  " +
                                   str(self.STEERING_THR2) + " - " + str(self.STEERING_THR3), dynamic_ncols=True)
        self.progress_bar12 = tqdm(initial=self.jj, total=self.MAX_DATA, desc="                                        High throttle | Steering:  " +
                                   str(self.STEERING_THR3) + " - " + str(self.STEERING_THR4), dynamic_ncols=True)
        self.progress_bar13 = tqdm(initial=self.hh, total=self.MAX_DATA, desc="                                        High throttle | Steering:  " +
                                   str(self.STEERING_THR4) + " - " + str(self.STEERING_THR5), dynamic_ncols=True)
        self.progress_bar14 = tqdm(initial=self.aa, total=self.MAX_DATA,
                                   desc="                                        High throttle | Steering:  " + str(self.STEERING_THR5) + " - max", dynamic_ncols=True)
    ...
    def collection_steering1(self):
        ...
        if (self.velocity < 0):
            self.acc1.append(-1*self.acceleration-self.g *
                             math.sin(math.radians(-1*self.pitch_angle)))
        ...
        dict1 = {'Velocity': self.vel1, 'Throttling': self.cmd1, 'Steering': self.steer1, 'Acceleration_with_pitch_comp': self.acc1,
                 'Acceleration_measured': self.accp1, 'Pitch_angle': self.pitch1, 'Index_low_cmd': self.k, "Index_high_cmd": self.kk}
    ...
    def collection_steering2(self):
        ...
        if (self.velocity < 0):
            self.acc2.append(-1*self.acceleration-self.g *
                             math.sin(math.radians(-1*self.pitch_angle)))
        ...
        # save data in csv file
        dict2 = {'Velocity': self.vel2, 'Throttling': self.cmd2, 'Steering': self.steer2, 'Acceleration_with_pitch_comp': self.acc2,
                 'Acceleration_measured': self.accp2, 'Pitch_angle': self.pitch2, 'Index_low_cmd': self.i, 'Index_high_cmd': self.ii}
    ...
    def collection_steering3(self):
        ...
        if (self.velocity < 0):
            self.acc3.append(-1*self.acceleration-self.g *
                             math.sin(math.radians(-1*self.pitch_angle)))
        ...
        # save data in csv file
        dict3 = {'Velocity': self.vel3, 'Throttling': self.cmd3, 'Steering': self.steer3, 'Acceleration_with_pitch_comp': self.acc3,
                 'Acceleration_measured': self.accp3, 'Pitch_angle': self.pitch3, 'Index_low_cmd': self.j, 'Index_high_cmd': self.jj}
    ...
    def collection_steering4(self):
        ...
        if (self.velocity < 0):
            self.acc4.append(-1*self.acceleration-self.g *
                             math.sin(math.radians(-1*self.pitch_angle)))
        ...
        # save data in csv file
        dict4 = {'Velocity': self.vel4, 'Throttling': self.cmd4, 'Steering': self.steer4, 'Acceleration_with_pitch_comp': self.acc4,
                 'Acceleration_measured': self.accp4, 'Pitch_angle': self.pitch4, 'Index_low_cmd': self.h, 'Index_high_cmd': self.hh}
    ...
    def collection_steering5(self):
        ...
        if (self.velocity < 0):
            self.acc5.append(-1*self.acceleration-self.g *
                             math.sin(math.radians(-1*self.pitch_angle)))
        ...
        # save data in csv file
        dict5 = {'Velocity': self.vel5, 'Throttling': self.cmd5, 'Steering': self.steer5, 'Acceleration_with_pitch_comp': self.acc5,
                 'Acceleration_measured': self.accp5, 'Pitch_angle': self.pitch5, 'Index_low_cmd': self.a, 'Index_high_cmd': self.aa}
