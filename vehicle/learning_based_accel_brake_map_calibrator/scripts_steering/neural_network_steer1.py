...
class NeuralNetworkSteering1(Node):
    ...
    def __init__(self):
        ...
        ush = pd.read_csv("steering_01.csv")
        ...
        plt.title("Distribution of Velocity - Table 1")
        plt.xlabel("Velocity")
        ...
        plt.title("Distribution of Throttling - Table 1")
        ...
        plt.title("Distribution of Acceleration - Table 1")
