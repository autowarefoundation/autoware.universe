...
from test_base.test_05_turn_indicators_cmd_and_report \
    import Test05TurnIndicatorsCmdAndReportBase
from test_base.test_05_turn_indicators_cmd_and_report \
    import TurnIndicatorsCommand_Constants
...
class Test05TurnIndicatorsCmdAndReportSim(Test05TurnIndicatorsCmdAndReportBase):
    ...
    def test_1_enable_left(self, setup_method):
        ...
        assert result.report == \
            TurnIndicatorsReport_Constants.ENABLE_LEFT.value
    ...
    def test_2_enable_right(self, setup_method):
        ...
        result = self.get_turn_indicators_status()
        assert result.report == \
            TurnIndicatorsReport_Constants.ENABLE_RIGHT.value
