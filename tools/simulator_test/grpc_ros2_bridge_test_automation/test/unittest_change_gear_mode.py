...
class TestGearCommandReport(unittest.TestCase):
    ...
    def set_gear_mode(self, gear_mode):
        ...
        self.assertEqual(received.command, gear_mode.value)
        self.msgs_rx.clear()
