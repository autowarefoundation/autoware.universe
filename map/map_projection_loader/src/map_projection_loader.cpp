  ...
  : Node("map_projection_loader")
{
  ...
  {
    RCLCPP_INFO(this->get_logger(), "Use default value for map_projector_info instead of loading file. NOTE: Please consider providing map_projector_info.yaml and setting `load_info_from_file` to false");
    msg.type = "local";
  }
  else
  {
