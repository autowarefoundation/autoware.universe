...
in the `mpc_lateral_controller_nodes` package.
...
Return LateralOutput which contains the following to [controller_node](../../mpc_lateral_controller_nodes/design/mpc_lateral_controller-design.md)
