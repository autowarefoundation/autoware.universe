...
: Node("lane_departure_checker_node", options)
{
  ...
  param_.nearest_ego_dist_threshold = declare_parameter<double>("nearest_ego_dist_threshold");
  param_.nearest_ego_yaw_threshold = declare_parameter<double>("nearest_ego_yaw_threshold");
