...
private:
  ...
  using SetPause = autoware::universe_component_interface_specs::control::SetPause;
  using IsPaused = autoware::universe_component_interface_specs::control::IsPaused;
