...
void ns_discretization::ODEfoh::operator()(const ode_matrix_t &V, ode_matrix_t &dVdt, const double t) const
{
...
void ns_discretization::ODEzoh::operator()(const ode_matrix_t &V, ode_matrix_t &dVdt, const double t) const
{
  const Model::state_vector_t x{V.col(0)};
  Model::input_vector_t u(Model::input_vector_t::Zero());
...
bool ns_discretization::multipleShootingTrajectory(Model::model_ptr_t const &model_ptr,
                                                   ...
                                                   discretization_data_t &dd)
{
  ...
  for (size_t k = 0; k < K; ++k)
  {
    ...
    if (auto const &&could_interpolate = piecewise_interpolator.Interpolate(s0s1, kappa0_kappa1);!could_interpolate)
    {
...
// We can also use the Bi-linear transformation method for discretization.
bool ns_discretization::bilinearTransformationOneStep(Model::model_ptr_t const &model_ptr,
                                                      Model::state_vector_t const &x0,
                                                      Model::input_vector_t const &u0,
                                                      Model::param_vector_t const &params0,
                                                      double const &dt,
