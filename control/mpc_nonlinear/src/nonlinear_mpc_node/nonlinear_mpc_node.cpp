...
void NonlinearMPCNode::computeClosestPointOnTraj()
{
  ...
  geometry_msgs::msg::Quaternion orient_msg =
      ns_utils::createOrientationMsgfromYaw(interp_yaw_angle);
...
std::array<double, 2> NonlinearMPCNode::computeErrorStates()
{
  ...
  //    std::array<double, 2>
  //    interpolated_pose_xy{current_interpolated_traj_point_ptr_->pose.position.x,
  //                                               current_interpolated_traj_point_ptr_->pose.position.y};
  //
  ...
  // double const &heading_yaw_error = -1.0 * ns_utils::angleDistance(vehicle_yaw_angle,
  // target_yaw);
  // double const &heading_yaw_error = 1.0 * ns_utils::wrapToPi(vehicle_yaw_angle - target_yaw);

  // auto const &heading_yaw_error =
  // autoware::common::helper_functions::wrap_angle(vehicle_yaw_angle - target_yaw);
  double heading_yaw_error = 1.0 * ns_utils::angleDistance(vehicle_yaw_angle, target_yaw);
...
void NonlinearMPCNode::updateInitialStatesAndControls_fromMeasurements()
{
  ...
  x0_initial_states_(7) =
      static_cast<double>(current_steering_ptr_->steering_tire_angle);  // steering state
