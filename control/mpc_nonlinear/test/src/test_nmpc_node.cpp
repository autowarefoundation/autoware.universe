...
/**
 * The trajectory initialization depends on the LPV feedback initializer class in the NMPC and it
 * makes use of the Lyapunov matrices which are used to compute state feedback coefficients. This
 * tests checks whether the feedback controllers are stable.
 *
 * */
...
/**
 * A straight trajectory path is give to the NMPC and it is expected to produce zero-steering angle
 * control command.
 * */
