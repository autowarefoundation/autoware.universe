...
ns_splines::BSplineSmoother::BSplineSmoother(size_t const &base_signal_length,
                                             double const &num_of_knots_ratio,
                                             double const &smoothing_factor)
  : lambda_{smoothing_factor}, npoints_{base_signal_length},
