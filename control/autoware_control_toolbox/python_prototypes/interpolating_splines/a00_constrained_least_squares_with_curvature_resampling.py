...
def piecewise_spline_func(t, coeffs):
...
def interp_spline(tvec, eta):
    ...
    for ti in tvec:
        ...
        try:
            ...
            a = 1
        xval = piecewise_spline_func(dt, piece_coeffs)
...
if __name__ == "__main__":
    ...
    xinterp = interp_spline(tvec_t0_be_interpolated, eta_x)
    yinterp = interp_spline(tvec_t0_be_interpolated, eta_y)
