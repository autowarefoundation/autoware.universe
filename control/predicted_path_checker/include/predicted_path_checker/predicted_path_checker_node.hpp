...
private:
  ...
  autoware::component_interface_utils::Subscription<
    autoware::universe_component_interface_specs::control::IsStopped>::SharedPtr sub_stop_state_;

  // Client
  autoware::component_interface_utils::Client<
    autoware::universe_component_interface_specs::control::SetStop>::SharedPtr cli_set_stop_;
  ...
  autoware::universe_component_interface_specs::control::IsStopped::Message::ConstSharedPtr
  ...
  void onIsStopped(
    const autoware::universe_component_interface_specs::control::IsStopped::Message::ConstSharedPtr
      msg);
