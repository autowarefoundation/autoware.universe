...
| use_trajectory_for_pitch_calculation | bool   | If true, pitch is estimated from the pre-defined map instead of the ego pose estimated in the localization module | false         |
