...
{
OdomGroundTruth::OdomGroundTruth(const rclcpp::NodeOptions & /*options*/)
: Node("odom_ground_truth")
{
  odom_sub_ = create_subscription<nav_msgs::msg::Odometry>(
    "/lgsvl/gnss_odom", 1, std::bind(&OdomGroundTruth::odomCallback, this, std::placeholders::_1));
