...
#include "simple_planning_simulator/vehicle_model/sim_model_delay_steer_map_acc_geard.hpp"
...
float64_t SimModelDelaySteerMapAccGeared::getX() { return state_(IDX::X); }
float64_t SimModelDelaySteerMapAccGeared::getY() { return state_(IDX::Y); }
float64_t SimModelDelaySteerMapAccGeared::getYaw() { return state_(IDX::YAW); }
float64_t SimModelDelaySteerMapAccGeared::getVx() { return state_(IDX::VX); }
float64_t SimModelDelaySteerMapAccGeared::getVy() { return 0.0; }
float64_t SimModelDelaySteerMapAccGeared::getAx() { return state_(IDX::ACCX); }
float64_t SimModelDelaySteerMapAccGeared::getWz()
{
  return state_(IDX::VX) * std::tan(state_(IDX::STEER)) / wheelbase_;
}
float64_t SimModelDelaySteerMapAccGeared::getSteer() { return state_(IDX::STEER); }
