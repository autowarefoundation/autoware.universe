...
| acc_scaling_factor   | double | scaling factor for accel command                     | x      | x      | x        | x      | o      | o        | 1.0           | [-]     |
| steer_scaling_factor | double | scaling factor for steer command                     | x      | x      | x        | x      | o      | o        | 1.0           | [-]     |
