...
public:
   ...
   * @param [in] acc_scaling_factor scaling factor for accel command
   * @param [in] steer_scaling_factor scaling factor for steering command
   */
  SimModelDelaySteerAccGeared(
    double vx_lim, double steer_lim, double vx_rate_lim, double steer_rate_lim, double wheelbase,
    double dt, double acc_delay, double acc_time_constant, double steer_delay,
    double steer_time_constant, double steer_dead_band, double acc_scaling_factor,
    double steer_scaling_factor);
...
private:
  ...
  const double acc_scaling_factor_;       //!< @brief scaling factor for accel command
  const double steer_scaling_factor_;     //!< @brief scaling factor for steering command
