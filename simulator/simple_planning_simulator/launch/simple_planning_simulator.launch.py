...
def generate_launch_description():
    ...
    simple_planning_simulator_node = launch_ros.actions.Node(
        ...
        parameters=[
            "{}/param/simple_planning_simulator_default.param.yaml".format(
                ament_index_python.get_package_share_directory("simple_planning_simulator")
            ),
    ...
    ld = launch.LaunchDescription(
        [vehicle_characteristics_param, simple_planning_simulator_node, map_to_odom_tf_publisher]
    )
    return ld
