...
void InterconnectedModel::getSignalNames(std::vector<char *> in_names, std::vector<char *> out_names)
{
...
void InterconnectedModel::generateConnections(std::vector<char *> in_names, std::vector<char *> out_names)
{
