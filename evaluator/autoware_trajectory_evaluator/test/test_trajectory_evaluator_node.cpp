...
protected:
  ...
  virtual void SetUp()
  {
    ...
    trajectory_publisher =
      node->create_publisher<autoware_planning_msgs::msg::Trajectory>("/input_trajectory", 10);
    odometry_publisher =
      node->create_publisher<nav_msgs::msg::Odometry>("/localization/kinematic_state", 10);
    ...
    evaluator_node =
      std::make_shared<trajectory_evaluator::TrajectoryEvaluatorNode>(rclcpp::NodeOptions());
  }
