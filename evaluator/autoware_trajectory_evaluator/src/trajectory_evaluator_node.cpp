...
void TrajectoryEvaluatorNode::onTrajectory(const autoware_planning_msgs::msg::Trajectory::ConstSharedPtr traj_msg, const nav_msgs::msg::Odometry::ConstSharedPtr odom_msg) {
    if (traj_msg != nullptr) {
