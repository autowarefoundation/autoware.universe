...
public:
  enum class TYPE {
    CALCULATION_TIME = 0,
    CALCULATION_TIME_PATH_PROCESSING,
    CALCULATION_TIME_OBSTACLE_CREATION,
    CALCULATION_TIME_COLLISION_CHECK,
    CALCULATION_TIME_PATH_PLANNING,
    LATERAL_DIST,
    LONGITUDINAL_DIST_OBSTACLE,
    LONGITUDINAL_DIST_COLLISION,
    COLLISION_POS_FROM_EGO_FRONT,
    STOP_DISTANCE,
    NUM_OBSTACLES,
    LATERAL_PASS_DIST,
