...
: SceneModuleManagerInterface(node, getModuleName())
{
...

  {
    ...
    p.use_ego_cut_lane = getOrDeclareParameter<bool>(node, ns + ".use_ego_cut_lane");
    ...
    p.egos_cut_lane_length = getOrDeclareParameter<double>(node, ns + ".egos_cut_lane_length");
  }
