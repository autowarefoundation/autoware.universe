...
You can choose whether to use this feature by parameter of `use_ego_cut_line`. The width of the line can be tuned with the parameter `egos_cut_line_length`.
