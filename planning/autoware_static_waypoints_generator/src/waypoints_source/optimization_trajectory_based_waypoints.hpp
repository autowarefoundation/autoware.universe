...
#ifndef WAYPOINTS_SOURCE__OPTIMIZATION_TRAJECTORY_BASED_WAYPOINTS_HPP_  // NOLINT
#define WAYPOINTS_SOURCE__OPTIMIZATION_TRAJECTORY_BASED_WAYPOINTS_HPP_  // NOLINT
...
public:
  ...
  std::vector<TrajectoryPoint> generate_waypoints_with_optimization(
...
// clang-format off
#endif  // WAYPOINTS_SOURCE__OPTIMIZATION_TRAJECTORY_BASED_WAYPOINTS_HPP_  // NOLINT
// clang-format on
