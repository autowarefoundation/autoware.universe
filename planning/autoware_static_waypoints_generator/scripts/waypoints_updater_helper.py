...
class CenterlineUpdaterHelper(Node):
    def __init__(self):
        super().__init__("waypoints_updater_helper")
        # Qt
        ...
        self.sub_whole_waypoints = self.create_subscription(
            Trajectory,
            "/static_waypoints_generator/output_whole_waypoints",
    ...
    def onWholeCenterline(self, whole_waypoints):
        self.widget.initWithEndIndex(len(whole_waypoints.points) - 1)
