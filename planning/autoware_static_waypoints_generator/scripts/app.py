...
from autoware_static_waypoints_generator.srv import LoadMap
from autoware_static_waypoints_generator.srv import PlanPath
from autoware_static_waypoints_generator.srv import PlanRoute
...
rclpy.init()
node = Node("static_waypoints_generator_http_server")
...
def get_map():
    ...
    # create client
    cli = create_client(LoadMap, "/planning/static_waypoints_generator/load_map")
...
def post_planned_route():
    ...
    # create client
    cli = create_client(PlanRoute, "/planning/static_waypoints_generator/plan_route")
...
def post_planned_path():
    ...
    # create client
    cli = create_client(PlanPath, "/planning/static_waypoints_generator/plan_path")
