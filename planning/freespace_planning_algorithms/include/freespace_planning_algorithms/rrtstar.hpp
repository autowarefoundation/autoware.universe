...
public:
  ...
  : RRTStar(
      ...
      RRTStarParam{
        node.declare_parameter("rrtstar.enable_update"),
        node.declare_parameter("rrtstar.use_informed_sampling"),
        node.declare_parameter("rrtstar.max_planning_time"),
        node.declare_parameter("rrtstar.neighbor_radius"),
        node.declare_parameter("rrtstar.margin")})
  {
  }
