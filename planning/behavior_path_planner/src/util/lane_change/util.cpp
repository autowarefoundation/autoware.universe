...
{
  const double s_start =
    std::invoke([&lane_changing_start_pose, &target_lanelets, &dist_prepare_to_lc_end,
      ...
      const double dist_from_front_target_lanelet =
        arc_to_start_pose.length + dist_prepare_to_lc_end.lane_changing;
