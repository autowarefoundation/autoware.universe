...
: Node("behavior_path_planner", node_options)
{
  ...
  debug_avoidance_info_array_publisher_ =
    create_publisher<AvoidanceInfoArray>("~/debug/avoidance_info_array", 1);
...
void BehaviorPathPlannerNode::run()
{
  ...
  debug_avoidance_info_array_publisher_->publish(bt_manager_->getAvoidanceInfoArray());
