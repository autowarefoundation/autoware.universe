...
| :-------------------------- | :------------------------------------------------------- | :--------------------------------------------------------------------------------------------- |
| ~/input/path                | `autoware_planning_msgs::msg::PathWithLaneId`            | the path generated by modules.                                                                 |
| ~/input/path_candidate      | `autoware_planning_msgs::msg::Path`                      | the path the module is about to take. to be executed as soon as external approval is obtained. |
| ~/input/turn_indicators_cmd | `autoware_vehicle_msgs::msg::TurnIndicatorsCommand` | turn indicators command.                                                                       |
...
The behavior path planner generates drivable area that is defined in `autoware_planning_msgs::msg::PathWithLaneId` and `autoware_planning_msgs::msg::Path` messages as:
...
The behavior path planner outputs turn signal information as `autoware_vehicle_msgs::msg::TurnIndicatorsCommand`. It uses rule-based algorithm to determine blinkers.
