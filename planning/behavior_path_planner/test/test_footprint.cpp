...
TEST(BehaviorPathPlanningFootprint, Polygon2dTranslation)
{
  ...
  drivable_area_expansion::Polygon2d translated_polygon =
    drivable_area_expansion::translate_polygon(polygon, 0.0, 0.0);
...
TEST(BehaviorPathPlanningPolygon2d, Polygon2dCreateFootprint)
{
  ...
  drivable_area_expansion::Polygon2d footprint =
    drivable_area_expansion::create_footprint(pose, base_footprint);
