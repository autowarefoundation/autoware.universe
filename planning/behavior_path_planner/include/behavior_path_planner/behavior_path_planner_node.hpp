...
using tier4_planning_msgs::msg::AvoidanceFactor;
using tier4_planning_msgs::msg::AvoidanceInfo;
...
private:
  ...
  rclcpp::Publisher<AvoidanceInfoArray>::SharedPtr debug_avoidance_info_array_publisher_;
