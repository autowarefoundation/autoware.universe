...
If you would like to know the overview rather than the detail, please skip the [Inner-workings / Algorithms](#inner-workings-algorithms) and refer to [FAQ](#frequently-asked-questions).
