  ...
  const geometry_msgs::msg::Point & stop_point, PathWithLaneId & output)
{
  ...
  const auto insert_idx =
    autoware::motion_utils::insert_stop_point(base_idx, stop_point, output.points);
...
{
  const auto insert_idx =
    autoware::motion_utils::insert_stop_point(stop_seg_idx, stop_point, output.points);
