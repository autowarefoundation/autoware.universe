...
{
  auto path = test::generatePath(0.0, 0.0, 10.0, 0.0, 10);
  autoware_planning_msgs::msg::PathPointWithLaneId path_point;
...
{
  autoware_planning_msgs::msg::PathWithLaneId path;
  autoware_planning_msgs::msg::PathPointWithLaneId point1;
  autoware_planning_msgs::msg::PathPointWithLaneId point2;
  autoware_planning_msgs::msg::PathPointWithLaneId point3;
