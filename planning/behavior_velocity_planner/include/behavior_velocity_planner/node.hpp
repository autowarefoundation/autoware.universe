...
private:
  ...
  // subscriber
  tilde::SteeSubscription<autoware_auto_planning_msgs::msg::PathWithLaneId>::SharedPtr
  ...
  tilde::SteeSubscription<nav_msgs::msg::Odometry>::SharedPtr sub_vehicle_odometry_;
  ...
  // publisher
  tilde::SteePublisher<autoware_auto_planning_msgs::msg::Path>::SharedPtr path_pub_;
