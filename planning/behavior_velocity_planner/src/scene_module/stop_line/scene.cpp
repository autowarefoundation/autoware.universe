  ...
  autoware_ad_api_msgs::motion::msg::MotionFactor * motion_factor)
{
  ...
  // Get stop point and stop factor
  {
    ...
    motion_factor->pose = stop_point_with_lane_id.point.pose;
  ...
  autoware_ad_api_msgs::motion::msg::MotionFactor * motion_factor)
{
  ...
  *motion_factor =
    planning_utils::initializeMotionFactor(autoware_ad_api_msgs::motion::msg::MotionFactor::STOP_LINE);
  ...
  if (state_ == State::APPROACH) {
    // Insert stop pose
    *path = insertStopPose(*path, *stop_pose_with_index, stop_reason, motion_factor);
