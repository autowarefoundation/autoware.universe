...
TEST_F(TestWithAdjLaneData, generateHalfLanelet)
{
  ...
  */
  ...
  autoware::test_utils::plot_lanelet2_object(
    half_lanelet, ax, LaneConfig{"generated", LineConfig{"red", 0.75}});
...
TEST_F(TestWithAdjLaneData, generateExtendedAdjacentLanelet)
{
  ...
  auto & ax = axes[0];
  autoware::test_utils::plot_lanelet2_object(
    lanelet, ax, autoware::test_utils::LaneConfig{"original", LineConfig{"blue", 2.0}});
  autoware::test_utils::plot_lanelet2_object(
    adj_lanelet, ax, autoware::test_utils::LaneConfig{"adjacent", LineConfig{"green", 2.0}});
  autoware::test_utils::plot_lanelet2_object(
    extended_adj_lanelet, ax, LaneConfig{"generated", LineConfig{"red", 0.75}});
  ...
  const std::string filename = std::string(
    ament_index_cpp::get_package_share_directory("autoware_behavior_velocity_blind_spot_module") +
    "/test_data/generateExtendedAdjacentLaneletTest.svg");
  plt.savefig(Args(filename));
#endif
}
