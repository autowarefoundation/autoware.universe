...
<figure markdown>
  ![example](docs/crosswalk/example.png){width=900}
...
<figure markdown>
  ![stop_margin](docs/crosswalk/stop_margin.svg){width=900}
...
<figure markdown>
  ![stop_line](docs/crosswalk/stop_line.svg){width=450}
  ![stop_line_distance](docs/crosswalk/stop_line_distance.svg){width=450}
...
<figure markdown>
  ![stop_line_margin](docs/crosswalk/stop_line_margin.svg){width=900}
...
<figure markdown>
  ![stuck_vehicle_attention_range](docs/crosswalk/stuck_vehicle_attention_range.svg){width=900}
...
<figure markdown>
  ![crosswalk_attention_range](docs/crosswalk/crosswalk_attention_range.svg){width=900}
...
<figure markdown>
  ![virtual_collision_point](docs/crosswalk/virtual_collision_point.svg){width=900}
...
<figure markdown>
  ![ttc-ttv](docs/crosswalk/ttc-ttv.svg){width=900}
...
<figure markdown>
  ![no-intension](docs/crosswalk/no-intension.svg){width=900}
...
<figure markdown>
  ![limitation](docs/crosswalk/limitation.svg){width=900}
