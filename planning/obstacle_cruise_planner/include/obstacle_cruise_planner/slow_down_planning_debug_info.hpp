...
#ifndef OBSTACLE_CRUISE_PLANNER__SLOW_DOWN_PLANNING_DEBUG_INFO_HPP_
#define OBSTACLE_CRUISE_PLANNER__SLOW_DOWN_PLANNING_DEBUG_INFO_HPP_
...
class SlowDownPlanningDebugInfo
{
public:
  enum class TYPE {
    // ego
...
#endif  // OBSTACLE_CRUISE_PLANNER__SLOW_DOWN_PLANNING_DEBUG_INFO_HPP_
