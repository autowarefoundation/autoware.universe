...
{
  frenet_planner::transform::Spline2D spline1({0.0, 1.0, 2.0}, {0.0, 1.0, 2.0});
  frenet_planner::transform::Spline2D spline2({-10.0, 5.0, -2.0}, {99.0, 3.0, -20.0});
}

TEST(splineTransform, toFrenet)
{
  frenet_planner::transform::Spline2D spline({0.0, 1.0, 2.0}, {0.0, 0.0, 0.0});
  ...
  frenet_planner::transform::Spline2D spline2({0.0, 1.0, 2.0}, {0.0, 1.0, 0.0});
