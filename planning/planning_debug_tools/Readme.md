...
PlotAccelerationOverArclength('v_behavior_path', behavior_path, tracker_time)
PlotAccelerationOverArclength('v_behavior_velocity', behavior_velocity, tracker_time)
PlotAccelerationOverArclength('v_motion_avoid', motion_avoid, tracker_time)
PlotAccelerationOverArclength('v_motion_smoother_latacc', motion_smoother_latacc, tracker_time)
PlotAccelerationOverArclength('v_motion_smoother', motion_smoother, tracker_time)
