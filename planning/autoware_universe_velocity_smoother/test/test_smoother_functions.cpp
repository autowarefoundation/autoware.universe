...
using autoware::universe::velocity_smoother::trajectory_utils::TrajectoryPoints;
...
TEST(TestTrajectoryUtils, CalcTrajectoryCurvatureFrom3Points)
{
  ...
  const auto checkOutputSize = [](const size_t trajectory_size, const size_t idx_dist) {
    ...
    const auto curvatures =
      autoware::universe::velocity_smoother::trajectory_utils::calcTrajectoryCurvatureFrom3Points(
