...
#ifndef ADAPTIVE_CRUISE_PLANNER__NODE_HPP_
#define ADAPTIVE_CRUISE_PLANNER__NODE_HPP_

#include "adaptive_cruise_planner/common_structs.hpp"
...
{
class AdaptiveCruisePlannerNode : public rclcpp::Node
{
public:
  explicit AdaptiveCruisePlannerNode(const rclcpp::NodeOptions & node_options);
...
#endif  // ADAPTIVE_CRUISE_PLANNER__NODE_HPP_
