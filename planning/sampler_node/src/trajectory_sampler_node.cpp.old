  ...
  tf_listener_(tf_buffer_)
{
  ...
  odom_sub_ = create_subscription<nav_msgs::msg::Odometry>(
    ...
    std::bind(&TrajectorySamplerNode::odomCallback, this, std::placeholders::_1));
...
std::optional<frenet_planner::Trajectory> TrajectorySamplerNode::selectBestTrajectory(
...
void TrajectorySamplerNode::odomCallback(const nav_msgs::msg::Odometry::SharedPtr msg)
{
  current_twist_ptr_->header = msg->header;
  current_twist_ptr_->twist = msg->twist.twist;
}

std::optional<sampler_common::Point> TrajectorySamplerNode::getCurrentEgoPose()
{
