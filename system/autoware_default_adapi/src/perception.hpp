...
#include <autoware/universe_component_interface_specs/perception.hpp>
...
private:
  ...
  Sub<autoware::universe_component_interface_specs::perception::ObjectRecognition>
    sub_object_recognized_;
  void object_recognize(const autoware::universe_component_interface_specs::perception::
