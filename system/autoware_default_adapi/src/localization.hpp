...
private:
  ...
  Cli<autoware::universe_component_interface_specs::localization::Initialize> cli_initialize_;
  Sub<autoware::universe_component_interface_specs::localization::InitializationState> sub_state_;
