...
private:
  ...
  Sub<autoware::component_interface_specs_universe::vehicle::TurnIndicatorStatus> sub_turn_indicator_;
  ...
  autoware::component_interface_specs_universe::localization::KinematicState::Message::ConstSharedPtr
  ...
  autoware::component_interface_specs_universe::vehicle::GearStatus::Message::ConstSharedPtr
    gear_status_msgs_;
  autoware::component_interface_specs_universe::vehicle::TurnIndicatorStatus::Message::ConstSharedPtr
  ...
  void kinematic_state(
    const autoware::component_interface_specs_universe::localization::KinematicState::Message::ConstSharedPtr
      msg_ptr);
  void acceleration_status(
    const autoware::component_interface_specs_universe::localization::Acceleration::Message::ConstSharedPtr
      msg_ptr);
  void steering_status(
    const autoware::component_interface_specs_universe::vehicle::SteeringStatus::Message::ConstSharedPtr
      msg_ptr);
  void gear_status(
    const autoware::component_interface_specs_universe::vehicle::GearStatus::Message::ConstSharedPtr
      msg_ptr);
  void turn_indicator_status(
    const autoware::component_interface_specs_universe::vehicle::TurnIndicatorStatus::Message::ConstSharedPtr
      msg_ptr);
  void map_projector_info(
    const autoware::component_interface_specs_universe::map::MapProjectorInfo::Message::ConstSharedPtr
      msg_ptr);
  void hazard_light_status(
    const autoware::component_interface_specs_universe::vehicle::HazardLightStatus::Message::ConstSharedPtr
      msg_ptr);
  void energy_status(
