...
private:
  ...
  Cli<autoware::universe_component_interface_specs::control::SetPause> cli_set_pause_;
  Sub<autoware::universe_component_interface_specs::control::IsPaused> sub_is_paused_;
  Sub<autoware::universe_component_interface_specs::control::IsStartRequested>
  ...
  void on_timer();
  void on_is_paused(
    const autoware::universe_component_interface_specs::control::IsPaused::Message::ConstSharedPtr
      msg);
  void on_is_start_requested(const autoware::universe_component_interface_specs::control::
