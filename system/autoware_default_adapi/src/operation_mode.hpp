...
private:
  ...
  using OperationModeRequest =
    autoware::universe_component_interface_specs::system::ChangeOperationMode::Service::Request;
  using AutowareControlRequest =
    autoware::universe_component_interface_specs::system::ChangeAutowareControl::Service::Request;
  ...
  Sub<autoware::universe_component_interface_specs::system::OperationModeState> sub_state_;
  Cli<autoware::universe_component_interface_specs::system::ChangeOperationMode> cli_mode_;
  Cli<autoware::universe_component_interface_specs::system::ChangeAutowareControl> cli_control_;
