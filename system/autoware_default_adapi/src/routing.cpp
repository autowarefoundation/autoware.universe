  ...
  const autoware::ad_api_specs::routing::SetRoutePoints::Service::Response::SharedPtr res)
{
  if (state_.state != State::Message::UNSET) {
    res->status = route_already_set<autoware::ad_api_specs::routing::SetRoutePoints>();
    return;
  }
...
{
  if (state_.state != State::Message::UNSET) {
    res->status = route_already_set<autoware::ad_api_specs::routing::SetRoute>();
    return;
  }
  ...
  const autoware::ad_api_specs::routing::SetRoutePoints::Service::Response::SharedPtr res)
{
  if (state_.state != State::Message::SET) {
    res->status = route_is_not_set<autoware::ad_api_specs::routing::SetRoutePoints>();
    return;
  }
  res->status = conversion::convert_call(cli_set_waypoint_route_, req);
}
...
{
  if (state_.state != State::Message::SET) {
    res->status = route_is_not_set<autoware::ad_api_specs::routing::SetRoute>();
    return;
  }
  res->status = conversion::convert_call(cli_set_lanelet_route_, req);
}
