...
using GearReport = autoware::universe_component_interface_specs::vehicle::GearStatus::Message;
...
using HazardLightsReport =
  autoware::universe_component_interface_specs::vehicle::HazardLightStatus::Message;
using ApiHazardLight = autoware_adapi_v1_msgs::msg::HazardLights;
using MapProjectorInfo =
  autoware::universe_component_interface_specs::map::MapProjectorInfo::Message;
...
void VehicleNode::kinematic_state(const autoware::universe_component_interface_specs::localization::
                                    KinematicState::Message::ConstSharedPtr msg_ptr)
{
  kinematic_state_msgs_ = msg_ptr;
}

void VehicleNode::acceleration_status(const autoware::universe_component_interface_specs::
                                        localization::Acceleration::Message::ConstSharedPtr msg_ptr)
{
  acceleration_msgs_ = msg_ptr;
}

void VehicleNode::steering_status(const autoware::universe_component_interface_specs::vehicle::
...
void VehicleNode::energy_status(
  const autoware::universe_component_interface_specs::vehicle::EnergyStatus::Message::ConstSharedPtr
    msg_ptr)
{
