...
: Node("mrm_comfortable_stop_operator", node_options)
{
  ...
  pub_velocity_limit_clear_command_ =
    create_publisher<autoware_planning_msgs::msg::VelocityLimitClearCommand>(
...
{
  auto velocity_limit = autoware_planning_msgs::msg::VelocityLimit();
...
{
  auto velocity_limit_clear_command = autoware_planning_msgs::msg::VelocityLimitClearCommand();
