...
int main(int argc, char ** argv)
{
  ...
  int c = 0;
  int option_index = 0;
  std::string socket_path = hdd_reader_service::socket_path;
  ...
  // Initialize hdd-reader service
  hdd_reader_service::HddReaderService service(socket_path);
