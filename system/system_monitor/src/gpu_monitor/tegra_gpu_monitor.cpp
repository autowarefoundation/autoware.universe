...
void GPUMonitor::checkThrottling([[maybe_unused]]diagnostic_updater::DiagnosticStatusWrapper & stat)
{
  // Please emove the [[maybe_unused]] tag after implementation, it's a temp build fix
