...
void VehicleNode::publish_kinematics()
{
  ...
  if (map_projector_info_->projector_type == tier4_map_msgs::msg::MapProjectorType::MGRS) {
  ...
  } else if (map_projector_info_->projector_type == tier4_map_msgs::msg::MapProjectorType::LOCAL_CARTESIAN_UTM) {
