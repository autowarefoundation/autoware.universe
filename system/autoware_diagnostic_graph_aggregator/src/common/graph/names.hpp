...
namespace autoware::diagnostic_graph_aggregator::unit_name
{
...
namespace autoware::diagnostic_graph_aggregator::edit_name
{
...
#endif  // AUTOWARE__DIAGNOSTIC_GRAPH_AGGREGATOR__COMMON__GRAPH__NAMES_HPP_
