...
def launch_setup(context, *args, **kwargs):
    ...
    with open(LaunchConfiguration("sampling_planner_param_path").perform(context), "r") as f:
        sampling_planner_param = yaml.safe_load(f)["/**"]["ros__parameters"]
