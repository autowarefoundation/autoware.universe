# map4_localization_launch2

## Structure

![map4_localization_launch2](./localization_launch.drawio.svg)
...
```xml
  <include file="$(find-pkg-share map4_localization_launch2)/launch/localization.launch.xml">
    <!-- Parameter files -->
