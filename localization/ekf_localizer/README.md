...
- The covariance ellipse is bigger than threshold `warn_ellipse_size` for long axis and `warn_ellipse_size_lateral_direction` for lateral_direction.
...
- The covariance ellipse is bigger than threshold `error_ellipse_size` for long axis and `error_ellipse_size_lateral_direction` for lateral_direction.
