...
| `is_updated_map`                                    | whether map is updated. If the map update couldn't be performed or there was no need to update the map, it becomes `False` | `is_updated_map` is `True`. Or both `is_updated_map` and `is_need_rebuild` are `False`.                                                                                                     | none                            | `is_updated_map` is `False ` but `is_need_rebuild` is `True` `True`                                                                                                    |
