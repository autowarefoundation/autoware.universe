...
| `is_succeed_ndt_align_service`        | whether the process of ndt_align_service is succeed or not | failed. <br> (1) The map points is not set. <br> (2) The sensor points is not set. | none                          |
