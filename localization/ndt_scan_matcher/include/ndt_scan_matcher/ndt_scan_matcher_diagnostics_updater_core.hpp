...
private:
  void check_is_activated(diagnostic_updater::DiagnosticStatusWrapper & stat, const bool * const is_activated_ptr);
  void check_is_succeed_latest_ndt_aling_service(diagnostic_updater::DiagnosticStatusWrapper & stat, const bool * const is_succeed_latest_ndt_aling_service_ptr);
  void check_is_running_ndt_aling_service(diagnostic_updater::DiagnosticStatusWrapper & stat, const bool * const is_running_ndt_aling_service_ptr);
  ...
  std::shared_ptr<diagnostic_updater::FunctionDiagnosticTask> diagnostics_func_is_succeed_latest_ndt_aling_service;
  std::shared_ptr<diagnostic_updater::FunctionDiagnosticTask> diagnostics_func_is_running_ndt_aling_service;
