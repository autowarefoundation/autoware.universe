...
{
  scale_ = declare_parameter<double>("scale");
  error_ellipse_size_ = declare_parameter<double>("error_ellipse_size");
  warn_ellipse_size_ = declare_parameter<double>("warn_ellipse_size");
  error_ellipse_size_lateral_direction_ = declare_parameter<double>("error_ellipse_size_lateral_direction");
  warn_ellipse_size_lateral_direction_ = declare_parameter<double>("warn_ellipse_size_lateral_direction");
