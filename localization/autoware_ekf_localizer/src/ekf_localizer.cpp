  ...
  twist_queue_(params_.twist_smoothing_steps)
{
  ...
  pub_yaw_bias_ = create_publisher<autoware_internal_debug_msgs::msg::Float64Stamped>("estimated_yaw_bias", 1);
  ...
  pub_processing_time_ =
    create_publisher<autoware_internal_debug_msgs::msg::Float64Stamped>("debug/processing_time_ms", 1);
...
void EKFLocalizer::timer_callback()
{
  ...
  pub_processing_time_->publish(autoware_internal_debug_msgs::build<autoware_internal_debug_msgs::msg::Float64Stamped>()
                                  .stamp(current_time)
                                  .data(elapsed_time));
}
