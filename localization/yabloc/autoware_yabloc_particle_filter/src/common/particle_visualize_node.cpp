...
#include <autoware/yabloc_particle_filter/msg/particle_array.hpp>
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::yabloc::modularized_particle_filter::ParticleVisualize)
