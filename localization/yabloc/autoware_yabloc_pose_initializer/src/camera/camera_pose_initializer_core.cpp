...
#include "autoware/yabloc_pose_initializer/camera/camera_pose_initializer.hpp"
...
{
using autoware::yabloc::semantic_segmentation::SemanticSegmentation;
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::yabloc::CameraPoseInitializer)
