...
#ifndef AUTOWARE__YABLOC_COMMON__TRANSFORM_LINE_SEGMENTS_HPP_
#define AUTOWARE__YABLOC_COMMON__TRANSFORM_LINE_SEGMENTS_HPP_
...
#endif  // AUTOWARE__YABLOC_COMMON__TRANSFORM_LINE_SEGMENTS_HPP_
