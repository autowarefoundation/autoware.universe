...
#ifndef AUTOWARE__YABLOC_COMMON__GROUND_SERVER__UTIL_HPP_
#define AUTOWARE__YABLOC_COMMON__GROUND_SERVER__UTIL_HPP_
...
#endif  // AUTOWARE__YABLOC_COMMON__GROUND_SERVER__UTIL_HPP_
