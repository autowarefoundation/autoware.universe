...
#include "autoware/yabloc_common/ground_server/ground_server.hpp"
#include "autoware/yabloc_common/ground_server/polygon_operation.hpp"
#include "autoware/yabloc_common/ground_server/util.hpp"
...
namespace autoware::yabloc::ground_server
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::yabloc::ground_server::GroundServer)
