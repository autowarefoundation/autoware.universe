...
#include "autoware/yabloc_image_processing/segment_filter/segment_filter.hpp"
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::yabloc::segment_filter::SegmentFilter)
