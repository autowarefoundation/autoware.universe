...
#include "autoware/yabloc_image_processing/line_segment_detector/line_segment_detector.hpp"
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::yabloc::line_segment_detector::LineSegmentDetector)
