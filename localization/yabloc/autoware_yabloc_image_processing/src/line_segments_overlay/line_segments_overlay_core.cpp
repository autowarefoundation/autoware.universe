...
#include "autoware/yabloc_image_processing/line_segments_overlay/line_segments_overlay.hpp"
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::yabloc::line_segments_overlay::LineSegmentsOverlay)
