...
#include "autoware/yabloc_image_processing/graph_segment/graph_segment.hpp"
#include "autoware/yabloc_image_processing/graph_segment/histogram.hpp"
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::yabloc::graph_segment::GraphSegment)
