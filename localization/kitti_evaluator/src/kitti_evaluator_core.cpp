  ...
  geometry_msgs::msg::PoseStamped::ConstSharedPtr pose_ground_truth_msg_ptr)
{
  ...
  if (!vehicle_pose_queue.empty()) {
    ...
    // vehicle_trans(0,2), vehicle_trans(0,3)); RCLCPP_INFO(get_logger(), "%lf %lf %lf %lf",
    // vehicle_trans(1,0), vehicle_trans(1,1), vehicle_trans(1,2), vehicle_trans(1,3));
    // RCLCPP_INFO(get_logger(), "%lf %lf %lf %lf", vehicle_trans(2,0), vehicle_trans(2,1),
    // vehicle_trans(2,2), vehicle_trans(2,3)); RCLCPP_INFO(get_logger(), "%lf %lf %lf %lf",
    // vehicle_trans(3,0), vehicle_trans(3,1), vehicle_trans(3,2), vehicle_trans(3,3));
