...
def generate_test_description():
    test_pose_estimator_manager_launch_file = os.path.join(
        get_package_share_directory("pose_estimator_manager"),
        "launch",
        "pose_estimator_manager.launch.xml",
    )

    pose_estimator_manager = IncludeLaunchDescription(
        AnyLaunchDescriptionSource(test_pose_estimator_manager_launch_file),
...
class TestEKFLocalizer(unittest.TestCase):
    ...
    def test_node_link(self):
        ...
        self.test_node.create_subscription(
            String,
            "/pose_estimator_manager/debug/string",
