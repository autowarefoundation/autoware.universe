...
: SteeNode("LaneletMapFilter", node_options)
{
  ...
  // Set publisher
  {
    filtered_pointcloud_pub_ =
      this->create_stee_publisher<PointCloud2>("output", rclcpp::SensorDataQoS());
  }
  ...
  // Set subscriber
  {
    ...
    pointcloud_sub_ = this->create_stee_subscription<PointCloud2>(
