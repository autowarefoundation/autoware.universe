...
void PolygonRemoverComponent::update_polygon(const geometry_msgs::msg::Polygon::ConstSharedPtr & polygon_in)
{
...
sensor_msgs::msg::PointCloud2 PolygonRemoverComponent::remove_updated_polygon_from_cloud(const PointCloud2ConstPtr & cloud_in)
{
  if (will_visualize_) {
...
std::vector<PointCgal> PolygonRemoverComponent::polygon_geometry_to_cgal( const geometry_msgs::msg::Polygon::ConstSharedPtr & polygon_in)
{
