...
private:
  ...
  float ground_blockage_ratio_;
  float sky_blockage_ratio_;
  float ground_dust_ratio_;
  std::vector<float> ground_blockage_range_deg_;
  std::vector<float> sky_blockage_range_deg_;
  int blockage_kernel_;
  int blockage_frame_count_;
  int ground_blockage_count_;
  int sky_blockage_count_;
