  ...
  output_frame_(declare_parameter<std::string>("base_link", "base_link"))
{
  ...
  angular_velocity_stddev_yy_base_link_ =
    declare_parameter<double>("angular_velocity_stddev_yy", 0.03);
  angular_velocity_stddev_zz_base_link_ =
    declare_parameter<double>("angular_velocity_stddev_zz", 0.03);

  accel_stddev_base_link_ = declare_parameter<double>("acceleration_stddev", 10000.0);
...
void ImuCorrector::callbackImu(const sensor_msgs::msg::Imu::ConstSharedPtr imu_msg_ptr)
{
  ...
  imu_msg.angular_velocity.x -= angular_velocity_offset_x_base_link_;
  imu_msg.angular_velocity.y -= angular_velocity_offset_y_base_link_;
  imu_msg.angular_velocity.z -= angular_velocity_offset_z_base_link_;

  imu_msg_base_link.angular_velocity_covariance[COV_IDX::X_X] =
    angular_velocity_stddev_xx_base_link_ * angular_velocity_stddev_xx_base_link_;
  imu_msg_base_link.angular_velocity_covariance[COV_IDX::Y_Y] =
    angular_velocity_stddev_yy_base_link_ * angular_velocity_stddev_yy_base_link_;
  imu_msg_base_link.angular_velocity_covariance[COV_IDX::Z_Z] =
    angular_velocity_stddev_zz_base_link_ * angular_velocity_stddev_zz_base_link_;
  imu_msg_base_link.linear_acceleration_covariance[COV_IDX::X_X] =
    accel_stddev_base_link_ * accel_stddev_base_link_;
  imu_msg_base_link.linear_acceleration_covariance[COV_IDX::Y_Y] =
    accel_stddev_base_link_ * accel_stddev_base_link_;
  imu_msg_base_link.linear_acceleration_covariance[COV_IDX::Z_Z] =
    accel_stddev_base_link_ * accel_stddev_base_link_;
