...
#ifndef F1TENTH__PARTICLE_FILTER__RANGE_LIBC__INCLUDES__CUDARANGELIB_H_
#define F1TENTH__PARTICLE_FILTER__RANGE_LIBC__INCLUDES__CUDARANGELIB_H_
#endif

#ifndef M_PI
#define M_PI 3.141592653589793238462643383279502
#endif  // F1TENTH__PARTICLE_FILTER__RANGE_LIBC__INCLUDES__CUDARANGELIB_H_
...
public:
  ...
  void set_conversion_params(
    float w_scale, float w_angle, float w_origin_x, float w_origin_y, float w_sin_angle,
    float w_cos_angle)
  {
