...
(function (root, factory) {
  ...
  function isMouseEvent(event) {
    return Boolean(
      event && $.inArray(event.type, MOUSE_EVENTS) > -1 && typeof event.pageX === "number",
    );
  }
    ...
    $.extend($.SmartMenus, {
      ...
      prototype: {
        init: function (t) {
          ...
          if (!t) {
            ...
            this.$root
              ...
              $(window).on(
                getEventsNS({ "resize orientationchange": $.proxy(this.winResize, this) }, i),
              ),
        ...
        getOffset: function (t, e) {
          ...
          return (
            o || 0 === o || (o = e ? t[0].offsetHeight : t[0].offsetWidth), i && t.hide().css(i), o
          );
        },
        ...
        menuPosition: function (t) {
          ...
          if (
            (g
              ? ((e = M ? d - r - w : w), (i = this.opts.bottomToTopSubMenus ? -h - T : m + T))
            ...
            if (
              ...
              g ||
                (S > h && I + h > v + S ? (i += v + S - h - I) : (h >= S || v > I) && (i += v - I)),
              ...
              if (/(start|down)$/i.test(e.type))
                ...
                void 0 !== s.touchY &&
                  ((s.momentum =
                    15 *
                    Math.pow(
                      Math.abs(i.pageY - s.touchStartY) / (e.timeStamp - s.touchStartTime),
                      2,
            ...
            switch (t.keyCode) {
              ...
              case 32:
                ...
                if (s.is("a") && this.handleItemEvents(s)) {
                  ...
                  i &&
                    !i.is(":visible") &&
                    (this.itemClick({ currentTarget: t.target }), t.preventDefault());
                }
            }
        },
        rootOut: function (t) {
