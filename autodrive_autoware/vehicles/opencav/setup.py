...
package_name = 'autodrive_opencav'
...
setup(
    ...
    description='AutoDRIVE Ecosystem Autoware Integration for OpenCAV',
    license='BSD',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'autodrive_incoming_bridge = autodrive_opencav.autodrive_incoming_bridge:main', # AutoDRIVE incoming bridge
            'autodrive_outgoing_bridge = autodrive_opencav.autodrive_outgoing_bridge:main', # AutoDRIVE outgoing bridge
            'teleop_keyboard = autodrive_opencav.teleop_keyboard:main', # Teleoperation with keyboard
        ],
    },
)