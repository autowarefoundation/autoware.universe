...
setup(
    ...
    description='AutoDRIVE Ecosystem Autoware Integration for Nigel',
    license='BSD',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'autodrive_incoming_bridge = autodrive_nigel.autodrive_incoming_bridge:main', # AutoDRIVE incoming bridge
            'autodrive_outgoing_bridge = autodrive_nigel.autodrive_outgoing_bridge:main', # AutoDRIVE outgoing bridge
